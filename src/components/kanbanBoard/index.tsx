...
const KanbanBoardComponent = () => {
  ...
  return (
    <div className="container flex flex-col bg-[#f7feff] border-[#77c7cd] border-2 px-[1rem] py-[1rem] rounded-md w-[400px] mr-[30px] h-max">
      ...
      <div className="flex flex-row items-center hover:cursor-pointer w-max" onClick={() => setShowModal(true)}>
        <div className=" bg-white rounded-[50%] border-2 h-[20px] w-[20px] flex justify-center items-center mt-3">
          <p>+</p>
        </div>
            ...
            <div className="relative w-auto max-w-3xl mx-auto my-6">
              ...
              <div className="relative w-[50vh] flex flex-col bg-white border-0 rounded-lg shadow-lg outline-none focus:outline-none">
                ...
                <div className="relative flex-auto p-6">
                  ...
                  <input type="text" placeholder="Type Your Task" className="relative w-full px-3 py-3 text-sm placeholder-gray-400 bg-white border border-gray-600 outline-none r5unded text-slate-500 focus:outline-none focus:ring" />
